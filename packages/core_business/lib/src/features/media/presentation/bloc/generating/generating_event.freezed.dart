...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String title,  String? imageUrl,  String themeId,  String themeType,  int themeOrgId,  bool isHd,  bool isLongTime,  String serviceType,  String? videoUrl,  String? prompt)?  startGenerating,TResult Function()?  tickProgress,TResult Function()?  notifyComplete,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StartGenerating() when startGenerating != null:
return startGenerating(_that.title,_that.imageUrl,_that.themeId,_that.themeType,_that.themeOrgId,_that.isHd,_that.isLongTime,_that.serviceType,_that.videoUrl,_that.prompt);case _TickProgress() when tickProgress != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String title,  String? imageUrl,  String themeId,  String themeType,  int themeOrgId,  bool isHd,  bool isLongTime,  String serviceType,  String? videoUrl,  String? prompt)  startGenerating,required TResult Function()  tickProgress,required TResult Function()  notifyComplete,}) {final _that = this;
switch (_that) {
case _StartGenerating():
return startGenerating(_that.title,_that.imageUrl,_that.themeId,_that.themeType,_that.themeOrgId,_that.isHd,_that.isLongTime,_that.serviceType,_that.videoUrl,_that.prompt);case _TickProgress():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String title,  String? imageUrl,  String themeId,  String themeType,  int themeOrgId,  bool isHd,  bool isLongTime,  String serviceType,  String? videoUrl,  String? prompt)?  startGenerating,TResult? Function()?  tickProgress,TResult? Function()?  notifyComplete,}) {final _that = this;
switch (_that) {
case _StartGenerating() when startGenerating != null:
return startGenerating(_that.title,_that.imageUrl,_that.themeId,_that.themeType,_that.themeOrgId,_that.isHd,_that.isLongTime,_that.serviceType,_that.videoUrl,_that.prompt);case _TickProgress() when tickProgress != null:
return tickProgress();case _NotifyComplete() when notifyComplete != null:
...
class _StartGenerating implements GeneratingEvent {
  const _StartGenerating({required this.title, required this.imageUrl, this.themeId = '1', this.themeType = 'TEMPLATE', this.themeOrgId = 1, this.isHd = false, this.isLongTime = false, this.serviceType = 'IMAGE_TO_VIDEO', this.videoUrl, this.prompt});
...
@JsonKey() final  String serviceType;
...
@override
int get hashCode => Object.hash(runtimeType,title,imageUrl,themeId,themeType,themeOrgId,isHd,isLongTime,serviceType,videoUrl,prompt);

@override
String toString() {
  return 'GeneratingEvent.startGenerating(title: $title, imageUrl: $imageUrl, themeId: $themeId, themeType: $themeType, themeOrgId: $themeOrgId, isHd: $isHd, isLongTime: $isLongTime, serviceType: $serviceType, videoUrl: $videoUrl, prompt: $prompt)';
}
...
@useResult
$Res call({
 String title, String? imageUrl, String themeId, String themeType, int themeOrgId, bool isHd, bool isLongTime, String serviceType, String? videoUrl, String? prompt
});
...
/// Create a copy of GeneratingEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? title = null,Object? imageUrl = freezed,Object? themeId = null,Object? themeType = null,Object? themeOrgId = null,Object? isHd = null,Object? isLongTime = null,Object? serviceType = null,Object? videoUrl = freezed,Object? prompt = freezed,}) {
...
as bool,serviceType: null == serviceType ? _self.serviceType : serviceType // ignore: cast_nullable_to_non_nullable

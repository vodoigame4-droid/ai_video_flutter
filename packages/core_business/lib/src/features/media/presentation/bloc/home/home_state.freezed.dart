...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Resource<List<HomeCategoryEntity>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> trendingVideosState,  Resource<List<ThemeEntity>> newVideosState,  String currentLocale)?  ready,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Resource<List<HomeCategoryEntity>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> trendingVideosState,  Resource<List<ThemeEntity>> newVideosState,  String currentLocale)  ready,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Resource<List<HomeCategoryEntity>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> trendingVideosState,  Resource<List<ThemeEntity>> newVideosState,  String currentLocale)?  ready,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Ready() when ready != null:
...
class _Ready implements HomeState {
 ...
 final  Resource<List<HomeCategoryEntity>> categoriesState;
 final  String selectedCategory;
 final  Resource<List<ThemeEntity>> trendingVideosState;
 final  Resource<List<ThemeEntity>> newVideosState;
...
@useResult
$Res call({
 Resource<List<HomeCategoryEntity>> categoriesState, String selectedCategory, Resource<List<ThemeEntity>> trendingVideosState, Resource<List<ThemeEntity>> newVideosState, String currentLocale
});


$ResourceCopyWith<List<HomeCategoryEntity>, $Res> get categoriesState;$ResourceCopyWith<List<ThemeEntity>, $Res> get trendingVideosState;$ResourceCopyWith<List<ThemeEntity>, $Res> get newVideosState;
...
as Resource<List<HomeCategoryEntity>>,selectedCategory: null == selectedCategory ? _self.selectedCategory : selectedCategory // ignore: cast_nullable_to_non_nullable
...
as Resource<List<ThemeEntity>>,newVideosState: null == newVideosState ? _self.newVideosState : newVideosState // ignore: cast_nullable_to_non_nullable
as Resource<List<ThemeEntity>>,currentLocale: null == currentLocale ? _self.currentLocale : currentLocale // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$ResourceCopyWith<List<HomeCategoryEntity>, $Res> get categoriesState {
  
  return $ResourceCopyWith<List<HomeCategoryEntity>, $Res>(_self.categoriesState, (value) {
...
@override
@pragma('vm:prefer-inline')
$ResourceCopyWith<List<ThemeEntity>, $Res> get trendingVideosState {
  
  return $ResourceCopyWith<List<ThemeEntity>, $Res>(_self.trendingVideosState, (value) {
...
@override
@pragma('vm:prefer-inline')
$ResourceCopyWith<List<ThemeEntity>, $Res> get newVideosState {
  
  return $ResourceCopyWith<List<ThemeEntity>, $Res>(_self.newVideosState, (value) {

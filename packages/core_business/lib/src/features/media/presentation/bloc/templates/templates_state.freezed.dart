...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Resource<List<String>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> templatesState)?  ready,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Resource<List<String>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> templatesState)  ready,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Resource<List<String>> categoriesState,  String selectedCategory,  Resource<List<ThemeEntity>> templatesState)?  ready,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Ready() when ready != null:
...
class _Ready implements TemplatesState {
 ...
 final  Resource<List<ThemeEntity>> templatesState;
...
@useResult
$Res call({
 Resource<List<String>> categoriesState, String selectedCategory, Resource<List<ThemeEntity>> templatesState
});


$ResourceCopyWith<List<String>, $Res> get categoriesState;$ResourceCopyWith<List<ThemeEntity>, $Res> get templatesState;
...
@override
@pragma('vm:prefer-inline')
$ResourceCopyWith<List<ThemeEntity>, $Res> get templatesState {
  
  return $ResourceCopyWith<List<ThemeEntity>, $Res>(_self.templatesState, (value) {

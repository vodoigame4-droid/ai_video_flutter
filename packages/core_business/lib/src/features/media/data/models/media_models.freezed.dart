...
/// Create a copy of ThemeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? resultUrl = freezed,Object? sourceUrl = freezed,Object? sourceUrls = freezed,Object? thumbnailUrl = freezed,Object? prompt = freezed,Object? type = freezed,Object? orgId = null,}) {
...
/// Create a copy of ThemeModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? resultUrl = freezed,Object? sourceUrl = freezed,Object? sourceUrls = freezed,Object? thumbnailUrl = freezed,Object? prompt = freezed,Object? type = freezed,Object? orgId = null,}) {
...
@JsonKey(readValue: _readStringId) String get id; String get name;@JsonKey(name: 'themes') List<ThemeModel>? get theme;
...
@useResult
$Res call({
@JsonKey(readValue: _readStringId) String id, String name,@JsonKey(name: 'themes') List<ThemeModel>? theme
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(readValue: _readStringId)  String id,  String name, @JsonKey(name: 'themes')  List<ThemeModel>? theme)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeCategoryModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(readValue: _readStringId)  String id,  String name, @JsonKey(name: 'themes')  List<ThemeModel>? theme)  $default,) {final _that = this;
switch (_that) {
case _HomeCategoryModel():
return $default(_that.id,_that.name,_that.theme);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(readValue: _readStringId)  String id,  String name, @JsonKey(name: 'themes')  List<ThemeModel>? theme)?  $default,) {final _that = this;
switch (_that) {
case _HomeCategoryModel() when $default != null:
return $default(_that.id,_that.name,_that.theme);case _:
  return null;
...
class _HomeCategoryModel implements HomeCategoryModel {
  const _HomeCategoryModel({@JsonKey(readValue: _readStringId) required this.id, required this.name, @JsonKey(name: 'themes') required final  List<ThemeModel>? theme}): _theme = theme;
  factory _HomeCategoryModel.fromJson(Map<String, dynamic> json) => _$HomeCategoryModelFromJson(json);

@override@JsonKey(readValue: _readStringId) final  String id;
@override final  String name;
 final  List<ThemeModel>? _theme;
@override@JsonKey(name: 'themes') List<ThemeModel>? get theme {
  final value = _theme;
  if (value == null) return null;
...
mixin _$CreateTgvRequestModel {
 ...
 String get imageUrl; String get name; String get prompt; String get themeId; bool get isHd; bool get isLongTime; String get themeType; int get themeOrgId; String get serviceType; String? get videoUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,imageUrl,name,prompt,themeId,isHd,isLongTime,themeType,themeOrgId,serviceType,videoUrl);

@override
String toString() {
  return 'CreateTgvRequestModel(imageUrl: $imageUrl, name: $name, prompt: $prompt, themeId: $themeId, isHd: $isHd, isLongTime: $isLongTime, themeType: $themeType, themeOrgId: $themeOrgId, serviceType: $serviceType, videoUrl: $videoUrl)';
}
...
@useResult
$Res call({
 String imageUrl, String name, String prompt, String themeId, bool isHd, bool isLongTime, String themeType, int themeOrgId, String serviceType, String? videoUrl
});
...
/// Create a copy of CreateTgvRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? imageUrl = null,Object? name = null,Object? prompt = null,Object? themeId = null,Object? isHd = null,Object? isLongTime = null,Object? themeType = null,Object? themeOrgId = null,Object? serviceType = null,Object? videoUrl = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String imageUrl,  String name,  String prompt,  String themeId,  bool isHd,  bool isLongTime,  String themeType,  int themeOrgId,  String serviceType,  String? videoUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTgvRequestModel() when $default != null:
return $default(_that.imageUrl,_that.name,_that.prompt,_that.themeId,_that.isHd,_that.isLongTime,_that.themeType,_that.themeOrgId,_that.serviceType,_that.videoUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String imageUrl,  String name,  String prompt,  String themeId,  bool isHd,  bool isLongTime,  String themeType,  int themeOrgId,  String serviceType,  String? videoUrl)  $default,) {final _that = this;
switch (_that) {
case _CreateTgvRequestModel():
return $default(_that.imageUrl,_that.name,_that.prompt,_that.themeId,_that.isHd,_that.isLongTime,_that.themeType,_that.themeOrgId,_that.serviceType,_that.videoUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String imageUrl,  String name,  String prompt,  String themeId,  bool isHd,  bool isLongTime,  String themeType,  int themeOrgId,  String serviceType,  String? videoUrl)?  $default,) {final _that = this;
switch (_that) {
case _CreateTgvRequestModel() when $default != null:
return $default(_that.imageUrl,_that.name,_that.prompt,_that.themeId,_that.isHd,_that.isLongTime,_that.themeType,_that.themeOrgId,_that.serviceType,_that.videoUrl);case _:
  return null;
...
class _CreateTgvRequestModel implements CreateTgvRequestModel {
  const _CreateTgvRequestModel({required this.imageUrl, required this.name, required this.prompt, required this.themeId, required this.isHd, required this.isLongTime, required this.themeType, required this.themeOrgId, this.serviceType = 'IMAGE_TO_VIDEO', this.videoUrl});
...
/// Create a copy of CreateTgvRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? imageUrl = null,Object? name = null,Object? prompt = null,Object? themeId = null,Object? isHd = null,Object? isLongTime = null,Object? themeType = null,Object? themeOrgId = null,Object? serviceType = null,Object? videoUrl = freezed,}) {
...
/// Create a copy of MediaModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? imageUrl = freezed,Object? imageUrls = freezed,Object? imageQuantity = null,Object? requestId = null,Object? resultUrl = freezed,Object? finishedTime = freezed,Object? prompt = null,Object? isHd = null,Object? isLongTime = null,Object? themeId = null,Object? thumbnailUrl = freezed,Object? status = null,Object? createdAt = null,}) {
...
mixin _$PaginationMetaModel {
 ...
 int get page; int get take; int get total;@JsonKey(readValue: _readPageCount) int get pageCount;
...
@useResult
$Res call({
 int page, int take, int total,@JsonKey(readValue: _readPageCount) int pageCount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int page,  int take,  int total, @JsonKey(readValue: _readPageCount)  int pageCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginationMetaModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int page,  int take,  int total, @JsonKey(readValue: _readPageCount)  int pageCount)  $default,) {final _that = this;
switch (_that) {
case _PaginationMetaModel():
return $default(_that.page,_that.take,_that.total,_that.pageCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int page,  int take,  int total, @JsonKey(readValue: _readPageCount)  int pageCount)?  $default,) {final _that = this;
switch (_that) {
case _PaginationMetaModel() when $default != null:
return $default(_that.page,_that.take,_that.total,_that.pageCount);case _:
  return null;
...
class _PaginationMetaModel implements PaginationMetaModel {
  const _PaginationMetaModel({required this.page, required this.take, required this.total, @JsonKey(readValue: _readPageCount) required this.pageCount});
...
@override@JsonKey(readValue: _readPageCount) final  int pageCount;

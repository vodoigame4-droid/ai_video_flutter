...
class _MediaApiClient implements MediaApiClient {
  ...
  Future<BaseResponse<SuggestionResponseModel>> getSuggestionPrompt(
    SuggestionRequestModel request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<BaseResponse<SuggestionResponseModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/media/suggestion',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<SuggestionResponseModel> _value;
    try {
      _value = BaseResponse<SuggestionResponseModel>.fromJson(
        _result.data!,
        (json) =>
            SuggestionResponseModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  @override
  Future<BaseResponse<List<String>>> getBanners() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;

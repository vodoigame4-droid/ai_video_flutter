...
class _Translations$create$fr extends Translations$create$en {
	...
	@override String get inspiring => 'L\'IA réfléchit...';
	@override String get limit_dialog_title => 'Plus de suggestions gratuites';
	@override String get limit_dialog_desc => 'Vous avez utilisé les 3 suggestions gratuites. Veuillez passer à VIP pour profiter de suggestions illimitées !';
	...
	@override String get please_add_image_first => 'Veuillez d\'abord ajouter une image';
}
...
class _Translations$home_new$fr extends Translations$home_new$en {
	...
	// Translations
	@override String get welcomeToAppName => 'Bienvenue sur VidoVerse';
...
class _Translations$premium$fr extends Translations$premium$en {
	...
	@override String weekly_desc({required Object price}) => 'Accès illimité de 7 jours, puis ${price}/semaine';
	@override String get weekly_price => '199.000 đ';
	@override String get weekly_suffix => '/semaine';
	@override String get annually => 'Annuel';
	@override String annually_desc({required Object price}) => 'Seulement ${price}/semaine';
	...
	@override String billed_yearly({required Object price}) => 'Facturé ${price}/an - Annulez à tout moment';
}
...
class _Translations$privacy_dialog$fr extends Translations$privacy_dialog$en {
	...
	// Translations
	@override String get title => 'Consentement au traitement IA';
	@override String get desc => 'Pour générer du contenu IA, votre photo sélectionnée (y compris les informations faciales si présentes), votre invite textuelle et les paramètres de génération choisis seront téléchargés en toute sécurité sur nos serveurs d\'IA pour traitement.';
	@override String get cancel => 'Annuler';
	@override String get confirm => 'Confirmer';
	@override String get bullet_1 => 'Vos données sont utilisées uniquement pour générer le contenu demandé.';
	@override String get bullet_2 => 'Nous n\'utilisons pas vos photos ou données faciales pour la reconnaissance faciale, la vérification d\'identité, la publicité ou le ciblage.';
	@override String get bullet_3 => 'Vos données sont supprimées une fois le traitement terminé.';
	@override String get dont_show_again => 'Ne plus afficher';
	@override String get agree => 'Accepter';
	@override String agree_policy({required Object privacy, required Object terms}) => 'En continuant, vous acceptez notre ${privacy} et nos ${terms}.';
}
...
class _Translations$report_dialog$fr extends Translations$report_dialog$en {
	...
	@override String get bottom_sheet_title => 'Signaler la vidéo';
	@override String get option_offensive => 'Contenu offensant ou inapproprié';
	@override String get option_quality => 'Mauvaise qualité ou visages déformés';
	@override String get option_copyright => 'Violation des droits d\'auteur';
	@override String get option_bug => 'Erreur de génération de vidéo ou crash';
	@override String get option_other => 'Autres problèmes';
	@override String get thanks_msg => 'Merci pour votre signalement, nous allons l\'examiner et le corriger.';
	@override String get hint_other => 'Veuillez décrire le problème en détail...';
}
...
class _Translations$errors$fr extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => 'Pas assez de suggestions gratuites, veuillez passer à la version VIP';
...
// Path: guide
class _Translations$guide$fr extends Translations$guide$en {
	_Translations$guide$fr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get step_1 => 'Étape 1';
...
class _Translations$checkin$fr extends Translations$checkin$en {
	...
	@override String get subtitle => 'Récompenses quotidiennes!';
	@override String get today => 'Auj.';
	...
	@override String check_in_success({required Object credits}) => '+${credits} Crédits ! Enregistrement réussi.';
}
...
class _Translations$notification$fr extends Translations$notification$en {
	...
	@override String get checkin_title => 'Rappel de check-in quotidien 🎁';
	@override String get checkin_body => 'Il est temps de réclamer vos crédits gratuits quotidiens ! Ouvrez l\'application maintenant.';
	@override String get test_notification => 'Tester';
}
...
class _Translations$onboarding$page1$fr extends Translations$onboarding$page1$en {
	...
	// Translations
	@override String get title => 'Bienvenue sur VidoVerse';
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'create.inspiring' => 'L\'IA réfléchit...',
			'create.limit_dialog_title' => 'Plus de suggestions gratuites',
			'create.limit_dialog_desc' => 'Vous avez utilisé les 3 suggestions gratuites. Veuillez passer à VIP pour profiter de suggestions illimitées !',
			...
			'onboarding.page1.title' => 'Bienvenue sur VidoVerse',
			...
			'home_new.welcomeToAppName' => 'Bienvenue sur VidoVerse',
			...
			'premium.weekly_desc' => ({required Object price}) => 'Accès illimité de 7 jours, puis ${price}/semaine',
			'premium.weekly_price' => '199.000 đ',
			'premium.weekly_suffix' => '/semaine',
			'premium.annually' => 'Annuel',
			'premium.annually_desc' => ({required Object price}) => 'Seulement ${price}/semaine',
			...
			'premium.billed_yearly' => ({required Object price}) => 'Facturé ${price}/an - Annulez à tout moment',
			...
			'privacy_dialog.title' => 'Consentement au traitement IA',
			'privacy_dialog.desc' => 'Pour générer du contenu IA, votre photo sélectionnée (y compris les informations faciales si présentes), votre invite textuelle et les paramètres de génération choisis seront téléchargés en toute sécurité sur nos serveurs d\'IA pour traitement.',
			'privacy_dialog.cancel' => 'Annuler',
			'privacy_dialog.confirm' => 'Confirmer',
			'privacy_dialog.bullet_1' => 'Vos données sont utilisées uniquement pour générer le contenu demandé.',
			'privacy_dialog.bullet_2' => 'Nous n\'utilisons pas vos photos ou données faciales pour la reconnaissance faciale, la vérification d\'identité, la publicité ou le ciblage.',
			'privacy_dialog.bullet_3' => 'Vos données sont supprimées une fois le traitement terminé.',
			'privacy_dialog.dont_show_again' => 'Ne plus afficher',
			'privacy_dialog.agree' => 'Accepter',
			'privacy_dialog.agree_policy' => ({required Object privacy, required Object terms}) => 'En continuant, vous acceptez notre ${privacy} et nos ${terms}.',
			...
			'report_dialog.bottom_sheet_title' => 'Signaler la vidéo',
			'report_dialog.option_offensive' => 'Contenu offensant ou inapproprié',
			'report_dialog.option_quality' => 'Mauvaise qualité ou visages déformés',
			'report_dialog.option_copyright' => 'Violation des droits d\'auteur',
			'report_dialog.option_bug' => 'Erreur de génération de vidéo ou crash',
			'report_dialog.option_other' => 'Autres problèmes',
			'report_dialog.thanks_msg' => 'Merci pour votre signalement, nous allons l\'examiner et le corriger.',
			'report_dialog.hint_other' => 'Veuillez décrire le problème en détail...',
			...
			'errors.not_enough_suggestion_free' => 'Pas assez de suggestions gratuites, veuillez passer à la version VIP',
			...
			'checkin.check_in_success' => ({required Object credits}) => '+${credits} Crédits ! Enregistrement réussi.',
			...
			'notification.checkin_title' => 'Rappel de check-in quotidien 🎁',
			'notification.checkin_body' => 'Il est temps de réclamer vos crédits gratuits quotidiens ! Ouvrez l\'application maintenant.',
			'notification.test_notification' => 'Tester',

...
class _Translations$home_new$ko extends Translations$home_new$en {
	...
	// Translations
	@override String get welcomeToAppName => 'VidoVerse에 오신 것을 환영합니다';
...
class _Translations$checkin$ko extends Translations$checkin$en {
	...
	@override String check_in_success({required Object credits}) => '+${credits} 크레딧! 출석 체크가 완료되었습니다.';
}
...
class _Translations$onboarding$page1$ko extends Translations$onboarding$page1$en {
	...
	// Translations
	@override String get title => 'VidoVerse에 오신 것을 환영합니다';
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'splash.loading' => '로딩 중...',
			'onboarding.page1.title' => 'VidoVerse에 오신 것을 환영합니다',
			...
			'home_new.welcomeToAppName' => 'VidoVerse에 오신 것을 환영합니다',
			...
			'checkin.check_in_success' => ({required Object credits}) => '+${credits} 크레딧! 출석 체크가 완료되었습니다.',

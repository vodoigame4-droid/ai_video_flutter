...
class _Translations$result$ja extends Translations$result$en {
	...
	@override String get extend_video => '動画を延長';
	@override String get extends_title => '拡張';
	@override String get delete => '削除';
	@override String get share_success => '共有用ビデオリンクがコピーされました';
	@override String get download_success => 'ビデオがギャラリーに保存されました';
}
...
class _Translations$errors$ja extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => '無料の提案が不足しています。VIPにアップグレードしてください';
...
// Path: guide
class _Translations$guide$ja extends Translations$guide$en {
	_Translations$guide$ja._(TranslationsJa root) : this._root = root, super.internal(root);

	final TranslationsJa _root; // ignore: unused_field

	// Translations
	@override String get step_1 => 'ステップ1';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'result.extend_video' => '動画を延長',
			'result.extends_title' => '拡張',
			'result.delete' => '削除',
			...
			'errors.not_enough_suggestion_free' => '無料の提案が不足しています。VIPにアップグレードしてください',

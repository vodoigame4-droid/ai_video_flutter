...
class _Translations$profile$ar extends Translations$profile$en {
	...
	@override String get imageGeneration => 'إنشاء الفيديو';
}
...
class _Translations$errors$ar extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => 'لا توجد اقتراحات مجانية كافية، يرجى الترقية إلى VIP';
...
// Path: guide
class _Translations$guide$ar extends Translations$guide$en {
	_Translations$guide$ar._(TranslationsAr root) : this._root = root, super.internal(root);

	final TranslationsAr _root; // ignore: unused_field

	// Translations
	@override String get step_1 => 'الخطوة 1';
...
class _Translations$rating_dialog$ar extends Translations$rating_dialog$en {
	...
	@override String get encourage_us => 'شجعنا';
	@override String get rate_on_store => 'قيمنا على المتجر';
...
extension on TranslationsAr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'errors.not_enough_suggestion_free' => 'لا توجد اقتراحات مجانية كافية، يرجى الترقية إلى VIP',
			...
			'rating_dialog.encourage_us' => 'شجعنا',
			'rating_dialog.rate_on_store' => 'قيمنا على المتجر',

...
class TranslationsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$guide$es guide = _Translations$guide$es._(_root);
...
class _Translations$create$es extends Translations$create$en {
	...
	@override String get tap_upload => 'Sube tu foto y crea tu video de IA en segundos.';
	@override String get tap_to_upload_photo => 'Toca aquí para subir tu foto.';
	...
	@override String get trim_title => 'Cortar video';
	@override String get trim_save => 'Guardar';
	@override String get trimming_loading => 'Cortando video...';
	@override String get please_add_image_first => 'Por favor, agrega una imagen primero';
}
...
class _Translations$home_new$es extends Translations$home_new$en {
	...
	// Translations
	@override String get welcomeToAppName => 'Bienvenido a VidoVerse';
...
class _Translations$premium$es extends Translations$premium$en {
	...
	@override String get claim_discount => 'Reclamar descuento';
	@override String get no_thanks => 'No, gracias';
	@override String get buy_now => 'Comprar ahora';
	@override String get sub_discount_banner => 'HASTA 50% DE DESCUENTO CON SUSCRIPCIÓN';
	@override String get unlock_premium_desc => 'Desbloquea todas las funciones premium con un descuento especial';
	@override String get credit_5000 => '5.000 Créditos';
	@override String get price_5000 => '5.999.000 đ';
	@override String get itunes_disclaimer => 'Si se suscribe, el pago se cargará a su cuenta de iTunes una vez confirmada la compra. Su suscripción se renovará automáticamente a menos que se cancele al menos 24 horas antes del final del período de facturación actual. La renovación automática se puede gestionar en cualquier momento en la configuración de su cuenta de iTunes Store.';
...
class _Translations$privacy_dialog$es extends Translations$privacy_dialog$en {
	...
	// Translations
	@override String get title => 'Consentimiento de procesamiento de IA';
	@override String get desc => 'Para generar contenido de IA, la foto seleccionada (incluida la información facial si está presente), el mensaje de texto y la configuración de generación seleccionada se cargarán de forma segura a nuestros servidores de IA para su procesamiento.';
	@override String get cancel => 'Cancelar';
	@override String get confirm => 'Confirmar';
	@override String get bullet_1 => 'Sus datos se utilizan únicamente para generar el contenido que solicita.';
	@override String get bullet_2 => 'No utilizamos sus fotos o datos faciales para reconocimiento facial, verificación de identidad, publicidad o elaboración de perfiles.';
	@override String get bullet_3 => 'Sus datos se eliminan una vez finalizado el procesamiento.';
	@override String get dont_show_again => 'No volver a mostrar';
	@override String get agree => 'Aceptar';
	@override String agree_policy({required Object privacy, required Object terms}) => 'Al continuar, acepta nuestra ${privacy} y ${terms}.';
}
...
class _Translations$report_dialog$es extends Translations$report_dialog$en {
	...
	@override String get bottom_sheet_title => 'Reportar video';
	@override String get option_offensive => 'Contenido ofensivo o inapropiado';
	@override String get option_quality => 'Mala calidad o rostros distorsionados';
	@override String get option_copyright => 'Violación de derechos de autor';
	@override String get option_bug => 'Error de generación de video o caída';
	@override String get option_other => 'Otros problemas';
	@override String get thanks_msg => 'Gracias por su informe, lo revisaremos y modificaremos.';
	@override String get hint_other => 'Por favor, describa el problema en detalle...';
}
...
class _Translations$errors$es extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => 'No hay suficientes sugerencias gratuitas, por favor actualice a VIP';
	...
	@override String get video_too_long => 'El video debe durar menos de 10 segundos.';
	@override String get iap_purchase_cancelled => 'Compra cancelada.';
	@override String get iap_purchase_in_progress => 'La compra ya está en progreso.';
	@override String get iap_purchase_failed => 'Compra fallida.';
}

// Path: guide
class _Translations$guide$es extends Translations$guide$en {
	_Translations$guide$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get step_1 => 'Paso 1';
...
// Path: checkin
class _Translations$checkin$es extends Translations$checkin$en {
	_Translations$checkin$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Check-in';
	@override String get subtitle => '¡Premios diarios!';
	@override String get today => 'Hoy';
	@override String day({required Object n}) => 'Día ${n}';
	@override String get check_in_btn => 'Fichar';
	@override String get daily_bonus_notification => 'Notificación';
	@override String get disable_notification_title => '¿Desactivar notificaciones de check-in?';
...
// Path: connectivity
class _Translations$connectivity$es extends Translations$connectivity$en {
	_Translations$connectivity$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get no_internet_title => 'Sin conexión';
	@override String get no_internet_desc => 'Por favor, comprueba tu conexão a Internet para seguir usando la aplicación.';
	@override String get retry_button => 'Reintentar conexión';
}

// Path: notification
class _Translations$notification$es extends Translations$notification$en {
	_Translations$notification$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get checkin_title => 'Recordatorio de check-in diario 🎁';
	@override String get checkin_body => '¡Es hora de reclamar tus créditos gratis diarios! Abre la aplicación ahora.';
	@override String get test_notification => 'Probar';
}
...
// Path: debug
class _Translations$debug$es extends Translations$debug$en {
	_Translations$debug$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Menú de depuración';
	@override String get iap_page => 'Página IAP';
	@override String get buy_credits => 'Comprar créditos';
	@override String get generation_iap => 'IAP de generación';
	@override String get generation_buy_credits => 'Comprar créditos de generación';
	@override String get discount => 'Página de descuento';
	@override String get paywall_video => 'Página de video paywall';
	@override String get generating_page => 'Vista previa de la página de generación';
}
...
class _Translations$permission$es extends Translations$permission$en {
	...
	@override String get photos_rationale_desc => 'VidoVerse necesita permiso para acceder a tu galería y guardar los videos generados en tu dispositivo.';
...
class _Translations$onboarding$page1$es extends Translations$onboarding$page1$en {
	...
	// Translations
	@override String get title => 'Bienvenido a VidoVerse';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'create.tap_upload' => 'Sube tu foto y crea tu video de IA en segundos.',
			'create.tap_to_upload_photo' => 'Toca aquí para subir tu foto.',
			...
			'create.trim_title' => 'Cortar video',
			'create.trim_save' => 'Guardar',
			'create.trimming_loading' => 'Cortando video...',
			'create.please_add_image_first' => 'Por favor, agrega una imagen primero',
			...
			'onboarding.page1.title' => 'Bienvenido a VidoVerse',
			...
			'home_new.welcomeToAppName' => 'Bienvenido a VidoVerse',
			...
			'premium.claim_discount' => 'Reclamar descuento',
			'premium.no_thanks' => 'No, gracias',
			'premium.buy_now' => 'Comprar ahora',
			'premium.sub_discount_banner' => 'HASTA 50% DE DESCUENTO CON SUSCRIPCIÓN',
			'premium.unlock_premium_desc' => 'Desbloquea todas las funciones premium con un descuento especial',
			'premium.credit_5000' => '5.000 Créditos',
			'premium.price_5000' => '5.999.000 đ',
			'premium.itunes_disclaimer' => 'Si se suscribe, el pago se cargará a su cuenta de iTunes una vez confirmada la compra. Su suscripción se renovará automáticamente a menos que se cancele al menos 24 horas antes del final del período de facturación actual. La renovación automática se puede gestionar en cualquier momento en la configuración de su cuenta de iTunes Store.',
			...
			'privacy_dialog.title' => 'Consentimiento de procesamiento de IA',
			'privacy_dialog.desc' => 'Para generar contenido de IA, la foto seleccionada (incluida la información facial si está presente), el mensaje de texto y la configuración de generación seleccionada se cargarán de forma segura a nuestros servidores de IA para su procesamiento.',
			'privacy_dialog.cancel' => 'Cancelar',
			'privacy_dialog.confirm' => 'Confirmar',
			'privacy_dialog.bullet_1' => 'Sus datos se utilizan únicamente para generar el contenido que solicita.',
			'privacy_dialog.bullet_2' => 'No utilizamos sus fotos o datos faciales para reconocimiento facial, verificación de identidad, publicidad o elaboración de perfiles.',
			'privacy_dialog.bullet_3' => 'Sus datos se eliminan una vez finalizado el procesamiento.',
			'privacy_dialog.dont_show_again' => 'No volver a mostrar',
			'privacy_dialog.agree' => 'Aceptar',
			'privacy_dialog.agree_policy' => ({required Object privacy, required Object terms}) => 'Al continuar, acepta nuestra ${privacy} y ${terms}.',
			...
			'report_dialog.bottom_sheet_title' => 'Reportar video',
			'report_dialog.option_offensive' => 'Contenido ofensivo o inapropiado',
			'report_dialog.option_quality' => 'Mala calidad o rostros distorsionados',
			'report_dialog.option_copyright' => 'Violación de derechos de autor',
			'report_dialog.option_bug' => 'Error de generación de video o caída',
			'report_dialog.option_other' => 'Otros problemas',
			'report_dialog.thanks_msg' => 'Gracias por su informe, lo revisaremos y modificaremos.',
			'report_dialog.hint_other' => 'Por favor, describa el problema en detalle...',
			...
			'errors.not_enough_suggestion_free' => 'No hay suficientes sugerencias gratuitas, por favor actualice a VIP',
			...
			'errors.video_too_long' => 'El video debe durar menos de 10 segundos.',
			'errors.iap_purchase_cancelled' => 'Compra cancelada.',
			'errors.iap_purchase_in_progress' => 'La compra ya está en progreso.',
			'errors.iap_purchase_failed' => 'Compra fallida.',
			'guide.step_1' => 'Paso 1',
			'guide.step_2' => 'Paso 2',
			...
			'checkin.today' => 'Hoy',
			'checkin.day' => ({required Object n}) => 'Día ${n}',
			'checkin.check_in_btn' => 'Fichar',
			'checkin.daily_bonus_notification' => 'Notificación',
			'checkin.disable_notification_title' => '¿Desactivar notificaciones de check-in?',
			...
			'notification.checkin_title' => 'Recordatorio de check-in diario 🎁',
			'notification.checkin_body' => '¡Es hora de reclamar tus créditos gratis diarios! Abre la aplicación ahora.',
			'notification.test_notification' => 'Probar',
			...
			'debug.generation_iap' => 'IAP de generación',
			...
			'debug.generating_page' => 'Vista previa de la página de generación',
			...
			'permission.photos_rationale_desc' => 'VidoVerse necesita permiso para acceder a tu galería y guardar los videos generados en tu dispositivo.',

...
class TranslationsDe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$guide$de guide = _Translations$guide$de._(_root);
	@override late final _Translations$checkin$de checkin = _Translations$checkin$de._(_root);
	@override late final _Translations$connectivity$de connectivity = _Translations$connectivity$de._(_root);
...
class _Translations$common$de extends Translations$common$en {
	...
	@override String get btn_continue => 'Weiter';
}
...
class _Translations$create$de extends Translations$create$en {
	...
	@override String get trim_title => 'Video schneiden';
	@override String get trim_save => 'Speichern';
	@override String get trimming_loading => 'Video wird geschnitten...';
	@override String get please_add_image_first => 'Bitte fügen Sie zuerst ein Bild hinzu';
}
...
class _Translations$profile$de extends Translations$profile$en {
	...
	@override String get imageGeneration => 'Videogenerierung';
}
...
class _Translations$premium$de extends Translations$premium$en {
	...
	@override String weekly_desc({required Object price}) => '7 Tage unbegrenzter Zugriff, dann ${price}/Woche';
	@override String get weekly_price => '199.000 đ';
	@override String get weekly_suffix => '/Woche';
	@override String get annually => 'Jährlich';
	@override String annually_desc({required Object price}) => 'Nur ${price}/Woche';
	...
	@override String billed_yearly({required Object price}) => '${price}/Jahr abgerechnet - Jederzeit kündbar';
}
...
class _Translations$report_dialog$de extends Translations$report_dialog$en {
	...
	@override String get bottom_sheet_title => 'Video melden';
	@override String get option_offensive => 'Anstößiger oder unangemessener Inhalt';
	@override String get option_quality => 'Schlechte Qualität oder verzerrte Gesichter';
	@override String get option_copyright => 'Urheberrechtsverletzung';
	@override String get option_bug => 'Fehler bei der Videoerstellung oder Absturz';
	@override String get option_other => 'Andere Probleme';
	@override String get thanks_msg => 'Vielen Dank für Ihre Meldung, wir werden sie prüfen und korrigieren.';
	@override String get hint_other => 'Bitte beschreiben Sie das Problem im Detail...';
}
...
class _Translations$errors$de extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => 'Nicht genügend kostenlose Vorschläge, bitte auf VIP upgraden';
	...
	@override String get video_too_long => 'Das Video muss unter 10 Sekunden lang sein.';
	@override String get iap_purchase_cancelled => 'Kauf abgebrochen.';
	@override String get iap_purchase_in_progress => 'Kauf wird bereits verarbeitet.';
	@override String get iap_purchase_failed => 'Kauf fehlgeschlagen.';
}

// Path: guide
class _Translations$guide$de extends Translations$guide$en {
	_Translations$guide$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get step_1 => 'Schritt 1';
	@override String get step_2 => 'Schritt 2';
	@override String get upload_photo => 'Foto hochladen';
	@override String get got_it => 'Ich habe es verstanden!';
	@override String get write_prompt => 'Prompt schreiben';
	@override String get upload_2_photos => '2 Fotos hochladen';
	@override String get generate => 'Generieren';
	@override String get upload_portrait => 'Porträt hochladen';
	@override String get choose_style => 'Stil wählen';
	@override String get add_assets => 'Assets hinzufügen';
}

// Path: checkin
class _Translations$checkin$de extends Translations$checkin$en {
	_Translations$checkin$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Check-in';
	@override String get subtitle => 'Tägliche Belohnungen!';
	@override String get today => 'Heute';
	@override String day({required Object n}) => 'Tag ${n}';
	@override String get check_in_btn => 'Einchecken';
	@override String get daily_bonus_notification => 'Benachrichtigung';
	@override String get disable_notification_title => 'Check-in-Benachrichtigungen deaktivieren?';
	@override String get disable_notification_desc => 'Sie verpassen die täglichen Login-Belohnungen und andere aufregende Boni. Sind Sie sicher, dass Sie deaktivieren möchten?';
	@override String get disable_notification_keep => 'Aktiviert lassen';
	@override String get disable_notification_disable => 'Deaktivieren';
	@override String check_in_success({required Object credits}) => '+${credits} Credits! Erfolgreich eingecheckt.';
}

// Path: connectivity
class _Translations$connectivity$de extends Translations$connectivity$en {
	_Translations$connectivity$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get no_internet_title => 'Keine Verbindung';
	@override String get no_internet_desc => 'Bitte überprüfen Sie Ihre Internetverbindung, um die App weiterhin zu nutzen.';
	@override String get retry_button => 'Verbindung erneut versuchen';
}

// Path: notification
class _Translations$notification$de extends Translations$notification$en {
	_Translations$notification$de._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: rating_dialog
class _Translations$rating_dialog$de extends Translations$rating_dialog$en {
	_Translations$rating_dialog$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Gefällt Ihnen die App?';
	@override String get desc => 'Bitte bewerten Sie uns und helfen Sie uns, Ihre Erfahrung zu verbessern. Vielen Dank!';
	@override String get support_us => 'Unterstütze uns';
	@override String get encourage_us => 'Ermutige uns';
	@override String get rate_on_store => 'Im Store bewerten';
	@override String get maybe_later => 'Vielleicht später';
	@override String get success => 'Vielen Dank für Ihre Unterstützung!';
}

// Path: debug
class _Translations$debug$de extends Translations$debug$en {
	_Translations$debug$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Debug-Menü';
	@override String get iap_page => 'IAP-Seite';
	@override String get buy_credits => 'Guthaben kaufen';
	@override String get generation_iap => 'Generierung IAP';
	@override String get generation_buy_credits => 'Generierung Guthaben kaufen';
	@override String get discount => 'Rabattseite';
	@override String get paywall_video => 'Paywall-Videoseite';
	@override String get generating_page => 'Vorschau der Generierungsseite';
}
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'create.trim_title' => 'Video schneiden',
			'create.trim_save' => 'Speichern',
			'create.trimming_loading' => 'Video wird geschnitten...',
			...
			'premium.weekly_desc' => ({required Object price}) => '7 Tage unbegrenzter Zugriff, dann ${price}/Woche',
			'premium.weekly_price' => '199.000 đ',
			'premium.weekly_suffix' => '/Woche',
			'premium.annually' => 'Jährlich',
			'premium.annually_desc' => ({required Object price}) => 'Nur ${price}/Woche',
			...
			'premium.billed_yearly' => ({required Object price}) => '${price}/Jahr abgerechnet - Jederzeit kündbar',
			...
			'report_dialog.bottom_sheet_title' => 'Video melden',
			'report_dialog.option_offensive' => 'Anstößiger oder unangemessener Inhalt',
			'report_dialog.option_quality' => 'Schlechte Qualität oder verzerrte Gesichter',
			'report_dialog.option_copyright' => 'Urheberrechtsverletzung',
			'report_dialog.option_bug' => 'Fehler bei der Videoerstellung oder Absturz',
			'report_dialog.option_other' => 'Andere Probleme',
			'report_dialog.thanks_msg' => 'Vielen Dank für Ihre Meldung, wir werden sie prüfen und korrigieren.',
			'report_dialog.hint_other' => 'Bitte beschreiben Sie das Problem im Detail...',
			...
			'errors.not_enough_suggestion_free' => 'Nicht genügend kostenlose Vorschläge, bitte auf VIP upgraden',
			...
			'errors.video_too_long' => 'Das Video muss unter 10 Sekunden lang sein.',
			'errors.iap_purchase_cancelled' => 'Kauf abgebrochen.',
			'errors.iap_purchase_in_progress' => 'Kauf wird bereits verarbeitet.',
			'errors.iap_purchase_failed' => 'Kauf fehlgeschlagen.',
			'guide.step_1' => 'Schritt 1',
			'guide.step_2' => 'Schritt 2',
			'guide.upload_photo' => 'Foto hochladen',
			'guide.got_it' => 'Ich habe es verstanden!',
			'guide.write_prompt' => 'Prompt schreiben',
			'guide.upload_2_photos' => '2 Fotos hochladen',
			'guide.generate' => 'Generieren',
			'guide.upload_portrait' => 'Porträt hochladen',
			'guide.choose_style' => 'Stil wählen',
			'guide.add_assets' => 'Assets hinzufügen',
			'checkin.title' => 'Check-in',
			'checkin.subtitle' => 'Tägliche Belohnungen!',
			'checkin.today' => 'Heute',
			'checkin.day' => ({required Object n}) => 'Tag ${n}',
			'checkin.check_in_btn' => 'Einchecken',
			'checkin.daily_bonus_notification' => 'Benachrichtigung',
			'checkin.disable_notification_title' => 'Check-in-Benachrichtigungen deaktivieren?',
			'checkin.disable_notification_desc' => 'Sie verpassen die täglichen Login-Belohnungen und andere aufregende Boni. Sind Sie sicher, dass Sie deaktivieren möchten?',
			'checkin.disable_notification_keep' => 'Aktiviert lassen',
			'checkin.disable_notification_disable' => 'Deaktivieren',
			'checkin.check_in_success' => ({required Object credits}) => '+${credits} Credits! Erfolgreich eingecheckt.',
			'connectivity.no_internet_title' => 'Keine Verbindung',
			'connectivity.no_internet_desc' => 'Bitte überprüfen Sie Ihre Internetverbindung, um die App weiterhin zu nutzen.',
			...
			'rating_dialog.encourage_us' => 'Ermutige uns',
			'rating_dialog.rate_on_store' => 'Im Store bewerten',
			'rating_dialog.maybe_later' => 'Vielleicht später',
			'rating_dialog.success' => 'Vielen Dank für Ihre Unterstützung!',
			'debug.title' => 'Debug-Menü',
			'debug.iap_page' => 'IAP-Seite',
			'debug.buy_credits' => 'Guthaben kaufen',
			'debug.generation_iap' => 'Generierung IAP',

...
class _Translations$errors$id extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => 'Saran gratis tidak cukup, silakan tingkatkan ke VIP';
...
extension on TranslationsId {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'errors.not_enough_suggestion_free' => 'Saran gratis tidak cukup, silakan tingkatkan ke VIP',

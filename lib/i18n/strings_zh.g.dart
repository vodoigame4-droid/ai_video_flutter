...
class _Translations$home_new$zh extends Translations$home_new$en {
	...
	// Translations
	@override String get welcomeToAppName => '欢迎使用VidoVerse';
...
class _Translations$generating$zh extends Translations$generating$en {
	...
	@override String get failed => '生成视频失败。请重试。';
}
...
class _Translations$errors$zh extends Translations$errors$en {
	...
	@override String get not_enough_suggestion_free => '免费建议不足，请升级到VIP';
...
class _Translations$onboarding$page1$zh extends Translations$onboarding$page1$en {
	...
	// Translations
	@override String get title => '欢迎使用VidoVerse';
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'splash.loading' => '加载中...',
			'onboarding.page1.title' => '欢迎使用VidoVerse',
			...
			'home_new.welcomeToAppName' => '欢迎使用VidoVerse',
			...
			'errors.not_enough_suggestion_free' => '免费建议不足，请升级到VIP',

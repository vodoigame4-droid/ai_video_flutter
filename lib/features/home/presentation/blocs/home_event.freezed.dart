...
/// @nodoc
abstract mixin class _$SelectCategoryCopyWith<$Res> implements $HomeEventCopyWith<$Res> {
...
class _ChangeLanguage implements HomeEvent {
  const _ChangeLanguage(this.localeCode);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChangeLanguage&&(identical(other.localeCode, localeCode) || other.localeCode == localeCode));
}
...
@override
String toString() {
  return 'HomeEvent.changeLanguage(localeCode: $localeCode)';
}
...
/// @nodoc
abstract mixin class _$ChangeLanguageCopyWith<$Res> implements $HomeEventCopyWith<$Res> {
...
/// Create a copy of HomeEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? localeCode = null,}) {
  return _then(_ChangeLanguage(
null == localeCode ? _self.localeCode : localeCode // ignore: cast_nullable_to_non_nullable
as String,
  ));
}

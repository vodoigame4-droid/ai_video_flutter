...
part of 'paywall_video_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaywallVideoState);
}
...
/// @nodoc
class $PaywallVideoStateCopyWith<$Res>  {
$PaywallVideoStateCopyWith(PaywallVideoState _, $Res Function(PaywallVideoState) __);
}


/// Adds pattern-matching-related methods to [PaywallVideoState].
extension PaywallVideoStatePatterns on PaywallVideoState {
...
class _Initial implements PaywallVideoState {
  const _Initial();
...
@override
String toString() {
  return 'PaywallVideoState.initial()';
}
...
class _Loading implements PaywallVideoState {
  const _Loading();
...
@override
String toString() {
  return 'PaywallVideoState.loading()';
}
...
class _Ready implements PaywallVideoState {
...
/// Create a copy of PaywallVideoState
...
@override
String toString() {
  return 'PaywallVideoState.ready(isWeeklySelected: $isWeeklySelected, isVideoRevealed: $isVideoRevealed)';
}
...
/// @nodoc
abstract mixin class _$ReadyCopyWith<$Res> implements $PaywallVideoStateCopyWith<$Res> {
...
class _Success implements PaywallVideoState {
...
@override
String toString() {
  return 'PaywallVideoState.success(message: $message, isWeeklySelected: $isWeeklySelected, isVideoRevealed: $isVideoRevealed)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $PaywallVideoStateCopyWith<$Res> {
...
class _Error implements PaywallVideoState {
...
@override
String toString() {
  return 'PaywallVideoState.error(message: $message, isWeeklySelected: $isWeeklySelected, isVideoRevealed: $isVideoRevealed)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PaywallVideoStateCopyWith<$Res> {

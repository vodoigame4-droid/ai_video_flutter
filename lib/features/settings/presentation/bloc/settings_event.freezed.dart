...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  init,TResult Function( AppLocale locale)?  changeLanguage,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Init() when init != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  init,required TResult Function( AppLocale locale)  changeLanguage,}) {final _that = this;
switch (_that) {
case _Init():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  init,TResult? Function( AppLocale locale)?  changeLanguage,}) {final _that = this;
switch (_that) {
case _Init() when init != null:
return init();case _ChangeLanguage() when changeLanguage != null:
return changeLanguage(_that.locale);case _:

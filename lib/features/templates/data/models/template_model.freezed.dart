...
@override
String toString() {
  return 'TemplateModel(id: $id, title: $title, imageUrl: $imageUrl, viewsCount: $viewsCount, badgeType: $badgeType)';
}
...
class _TemplateModel implements TemplateModel {
  const _TemplateModel({required this.id, required this.title, required this.imageUrl, required this.viewsCount, required this.badgeType});

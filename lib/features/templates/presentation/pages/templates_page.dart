...
class TemplatesPage extends StatelessWidget {
  ...
  const TemplatesPage({super.key, this.initialCategory = 'All'});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          sl<TemplatesBloc>()..add(TemplatesEvent.init(initialCategory)),
                ...
                builder: (context, state) {
                  return state.when(
                    ...
                    ready: (categoriesState, selectedCategory, templatesState) {
                      final currentTitle = _getTranslatedCategory(
                        context,
                        selectedCategory,
                      );
